...
const FilterModal = ({ name, openFilter, setOpenFilter, handleFilterObject, DATA }) => {
    ...
    const filters = name === "orders" ? Object.keys(DATA[0]).slice(1, -1) : name === "view-orders" ?  Object.keys(DATA[0]) : Object.keys(DATA[0]).slice(1) // sets DATA keys as filter criterias
