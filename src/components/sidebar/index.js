...
const AdminSidebar = () => {
    ...
    return (
        <aside className={`px-6 flex flex-col ${isSidebarToggled ? "w-fit" : "w-[266px]"} min-h-screen max-h-screen border-r border-1 border-[#E6E6E6] justify-between bg-[#ffffff] sticky top-0 pb-4 transition-all duration-300 ease-in`}>
