...
const TableFooter = ({pagination, data, handleItemsPerPage, prevPage, page, handlePage, nextPage, totalPages}) => {
    return (
        <div className="flex justify-between pt-4 pb-6 px-6 text-[13px] leading-[23px] items-center bg-[#ffffff] w-full ">
                    <div className="flex gap-8 text-[#CCCCCC] items-center">
                        ...
                        <p>Showing {pagination.count.start} to {pagination.count.stop} of {data.length} orders</p>
                    </div>
