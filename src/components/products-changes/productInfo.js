...
export const ProductInfo = ({ name, productInfo, isProductInfoOpen, handleProductInfo }) => {
  ...
  return (
    <div className={`${isProductInfoOpen ? "" : "hidden"}`}>
      <div className="flex justify-between items-center pb-[25px]">
        ...
        <div className="w-[48%]">
          <div className="text-[13px] text-[#B3B3B3]">Availability</div>
          <div>
            <input
              className="py-[8px] px-[20px] bg-[#F2F2F2] border rounded-[4px] w-[100%] focus:outline-green"
              type="text"
              ...
              onChange={(e) => {
                ...
                handleProductInfo("availabilty", e.target.value);
              }}
            />
          </div>
        </div>
          ...
          <div>
            <input
              ...
              onChange={(e) => {
                ...
                handleProductInfo("price", e.target.value);
              }}
            />
          </div>
        </div>
          ...
          <div>
            <input
              ...
              onChange={(e) => {
                ...
                handleProductInfo("discount", e.target.value);
              }}
            />
          </div>
        </div>
