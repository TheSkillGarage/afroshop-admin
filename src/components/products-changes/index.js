...
const ProductChanges = ({ name, productInfo }) => {
    ...
    const [text, setText] = useState(name === "edit" ? productInfo.description : "");
    const [selectedCategory, setSelectedCategory] = useState(name === "edit" ? productInfo.category : "");
    const [productName, setProductName] = useState(name === "edit" ? productInfo.name : "");
    const [productAvailability, setProductAvailability] = useState(productInfo.availabilty);
    const [productPrice, setProductPrice] = useState(name === "edit" ? productInfo.price : "");
    const [productDiscount, setProductDiscount] = useState(name === "edit" ? productInfo.discount : "");
    const [selectedFiles, setSelectedFiles] = useState(name === "edit" ? productInfo.images : []);


    const handleProductName = (e) => setProductName(e.target.value);
    const handleProductAvailability = (e) => setProductAvailability(e.target.value);
    const handleProductPrice = (e) => setProductPrice(e.target.value);
    const handleProductDiscount = (e) => setProductDiscount(e.target.value);
        ...
        <div className="w-[100%] mx-auto bg-[#F2F2F2]">
            <div className="py-[12px]">
                <div className="flex items-center py-[8px] text-[13px] px-[24px]">
                    ...
                    {name !== "edit" ? <span className="text-green"> Add New Products</span>
                        :
                                            ...
                                            <div className="w-[45%]">
                                                ...
                                                <div>
                                                    <input
                                                        ...
                                                        onChange={(e) => handleProductAvailability(e)}
                                                    />
                                                </div>
                                            </div>
                                        </div>
